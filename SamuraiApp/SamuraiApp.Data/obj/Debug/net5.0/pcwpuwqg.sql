...
CREATE TABLE [Horse] (
    ...
    CONSTRAINT [FK_Horse_Samurais_SamuraiId] FOREIGN KEY ([SamuraiId]) REFERENCES [Samurais] ([Id]) ON DELETE CASCADE
);
GO

CREATE UNIQUE INDEX [IX_Horse_SamuraiId] ON [Horse] ([SamuraiId]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210525065638_horse', N'5.0.6');
GO
